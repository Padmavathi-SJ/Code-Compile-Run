...
import '../../../css/User/ProblemsMainPage.css';
        ...
        <div className='main-container'>
            ...
            <div className='ongoing-container' style={{ cursor: 'pointer' }}>
                <Link to="JavaProblemList">
                    <img src="/images/Java-program.png" alt="Java Problems" className='ongoing-image' />
                </Link>
            ...
            <div className='ongoing-container' style={{ cursor: 'pointer' }}>
                <Link to="PythonProblemList">
                    <img src="/images/Python-program.png" alt="Python Problems" className='ongoing-image' />
                </Link>
